...
export const translations: Translations = {
  en: {
    ...
    heroLead: "Never trust a teacher that says “it's just because; there's no rule”. I'm Carlos, and I'm ready to explain why. Hundreds of professionals have trusted me with their Japanese over the past ten years. Using 7Step — the framework I developed during my PhD — English and Spanish speakers reach fluency faster and learn kanji up to three times quicker, by finally making sense of the sound radicals hidden in most kanji. Every lesson is personalised and built for real use and passing the JLPT.",
    showMore: "Show more",
    showLess: "Show less",
  ...
  es: {
    ...
    heroLead: "Nunca te fíes de un profesor que dice “es así porque sí; no hay regla”. Soy Carlos, y estoy listo para explicarte el porqué. Cientos de profesionales me han confiado su japonés en los últimos diez años. Con 7Step, el método que desarrollé durante mi doctorado, los hablantes de inglés y español alcanzan la fluidez antes y aprenden los kanji hasta tres veces más rápido, entendiendo por fin los radicales fonéticos que esconde la mayoría de los kanji. Cada clase es personalizada y está pensada para usar el japonés de verdad y aprobar el JLPT.",
    showMore: "Ver más",
    showLess: "Ver menos",
  ...
  fr: {
    ...
    heroLead: "Ne faites jamais confiance à un professeur qui dit « c'est comme ça ; il n'y a pas de règle ». Je suis Carlos, et je suis prêt à vous expliquer pourquoi. Depuis dix ans, des centaines de professionnels m'ont confié leur japonais. Avec 7Step, la méthode que j'ai mise au point pendant mon doctorat, les anglophones et hispanophones atteignent la fluidité plus vite et apprennent les kanji jusqu'à trois fois plus rapidement, en comprenant enfin les radicaux phonétiques cachés dans la plupart des kanji. Chaque cours est personnalisé et pensé pour un usage réel du japonais et pour réussir le JLPT.",
    showMore: "Voir plus",
    showLess: "Voir moins",
  ...
  gl: {
    ...
    heroLead: "Nunca te fíes dun profesor que di “é así porque si; non hai regra”. Son Carlos, e estou listo para explicarche o porqué. Centos de profesionais confiáronme o seu xaponés nos últimos dez anos. Con 7Step, o método que desenvolvín durante o meu doutoramento, os falantes de inglés e español acadan a fluidez antes e aprenden os kanji ata tres veces máis rápido, entendendo por fin os radicais fonéticos que agocha a maioría dos kanji. Cada clase é personalizada e está pensada para usar o xaponés de verdade e aprobar o JLPT.",
    showMore: "Ver máis",
    showLess: "Ver menos",
    trustGoogle: "en Google",
    trustLinkedIn: "en LinkedIn",
